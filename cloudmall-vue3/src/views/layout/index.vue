...
<template>
  <div class="common-layout">
    <el-dialog v-model="dialogStatusVisible" title="店铺状态设置" width="500">
      <el-radio-group v-model="status_active">
        <el-radio :value="1" size="large">营业中
          <span>当前商店处于营业状态，自动接收任何订单，可点击打烊进入店铺打烊状态。</span>
        </el-radio>
        <el-radio :value="0" size="large">打烊中
          <span>当前商店处于打烊状态，仅接受营业时间内的预定订单，可点击营业中手动恢复营业状态。</span>
        </el-radio>
      </el-radio-group>
      <template #footer>
    ...
    <el-container>
      <el-header>
        <img src="../../assets/image/cloudmall_logo.png" class="logo" />
      ...
      <el-container class="box1">
        ...
        <el-menu :width="isCollapse ? '640px' : '200px'" :default-active="getActiveAside()" :collapse="isCollapse"
          background-color="#00ff00" text-color="#fff" unique-opened router>
