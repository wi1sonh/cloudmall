...
import fun.cmgraph.exception.AddressBookBusinessException;
import fun.cmgraph.exception.OrderBusinessException;
import fun.cmgraph.exception.ShoppingCartBusinessException;
import fun.cmgraph.mapper.*;
import fun.cmgraph.result.PageResult;
import fun.cmgraph.service.OrderService;
import fun.cmgraph.utils.HttpClientUtil;
import fun.cmgraph.utils.WeChatPayUtil;
...
import fun.cmgraph.websocket.WebSocketServer;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Value("${cloudmall.shop.address}")
    private String shopAddress;
    @Value("${cloudmall.baidu.ak}")
    private String ak;
