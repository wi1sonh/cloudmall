package fun.cmgraph.aspect;

import fun.cmgraph.annotation.AutoFill;
import fun.cmgraph.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点表达式，封装成一个小方法
     */
    @Pointcut("execution(* fun.cmgraph.mapper.*.*(..)) && @annotation(fun.cmgraph.annotation.AutoFill)")
